...
export default function NewRFQPage() {
    ...
    const addLine = () => {
        setLines([...lines, { product_id: '', name: '', product_qty: 1, price_unit: 0, price_subtotal: 0 }]);
    };
            ...
            <div className="flex-1 overflow-auto p-4 bg-[#0F172A]">
                <div className="max-w-5xl mx-auto bg-[#1E293B] rounded border border-gray-700 p-6">
                    ...
                    <div className="flex items-center justify-between mb-6 border-b border-gray-700 pb-4">
                        ...
                        <div className="text-xl font-bold text-gray-200">New Request for Quotation</div>
                    </div>

                    {/* Form Fields */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                        <div>
                            <label className="block text-sm font-medium text-purple-400 mb-1">Vendor</label>
                            <select
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-400 mb-1">Order Deadline</label>
                            <input
                                type="date"
                                className="w-full bg-[#0F172A] border border-gray-600 rounded px-3 py-2 text-white focus:border-purple-500 outline-none"
                            />
                    ...
                    <div className="mb-8">
                        <div className="flex items-center justify-between mb-2">
                            <h3 className="text-lg font-semibold text-gray-200">Products</h3>
                        </div>
